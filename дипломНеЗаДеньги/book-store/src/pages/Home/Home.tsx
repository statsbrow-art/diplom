        ...
        <div className="container">
          ...
          <div className="categories-grid">
            <Link to="/catalog?category=fiction" className="category-card">
              <img src="https://images.unsplash.com/photo-1544947950-fa07a98d237f?w=300&h=200&fit=crop" alt="Художественная литература" />
              <span>Художественная литература</span>
            </Link>
            <Link to="/catalog?category=non-fiction" className="category-card">
              <img src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?w=300&h=200&fit=crop" alt="Нехудожественная литература" />
              <span>Нехудожественная литература</span>
            </Link>
            <Link to="/catalog?category=children" className="category-card">
              <img src="https://images.unsplash.com/photo-1512820790803-83ca734da794?w=300&h=200&fit=crop" alt="Детские книги" />
              <span>Детские книги</span>
            </Link>
            <Link to="/catalog?category=business" className="category-card">
              <img src="https://images.unsplash.com/photo-1524995997946-a1c2e315a42f?w=300&h=200&fit=crop" alt="Бизнес-литература" />
